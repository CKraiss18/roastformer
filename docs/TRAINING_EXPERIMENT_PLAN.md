...
- Methodology (50 pts) - ✅ DRAFTED (METHODOLOGY_COURSE_CONNECTIONS.md)
- Implementation & Demo (20 pts) - ⚠️ EXPERIMENTS NEEDED
- Evaluation Framework (15 pts) - ⚠️ WRITEUP NEEDED
...
**What to Collect:**
1. ✅ `training_summary.txt` (auto-generated by Colab)
2. ✅ Training curves PNG (loss over epochs)
3. ✅ Best model checkpoint (`best_transformer_model.pt`)
4. ✅ Metrics:
   - Final train loss
...
**What to Collect:**
1. ✅ Training summary and curves (same as Exp 1)
2. ✅ Comparison table:
...
**Time**: 2-3 hours
**Priority**: ⭐ MEDIUM (enhances presentation)
...
4. Create heatmap: timesteps × timesteps
...
**GPU Time**: 1 hour
**Priority**: ⭐ MEDIUM (tests novel contribution)
...
|--------|------------------------|-----------------|------------|
| Val loss | X.XX°F | X.XX°F | ΔX.XX°F |
| MAE | X.XX°F | X.XX°F | ΔX.XX°F |
...
- ✅ Loss decreases over epochs (not flat/diverging)
- ✅ Generated profiles have reasonable temperature ranges (350-450°F)
- ✅ Can load checkpoint and generate new profiles

### **Experiment 1 (Baseline) - Good Success:**
- ✅ Validation loss < 15°F
- ✅ Generated profiles visually resemble real ones
- ✅ >80% compliance with physics constraints (monotonicity, RoR)
- ✅ Model reaches early stopping before epoch 100

### **Experiment 1 (Baseline) - Great Success:**
- ✅ Validation loss < 10°F
- ✅ MAE < 5°F on test profiles
...
- ✅ Can compare performance quantitatively (loss, MAE)
- ✅ Can explain trade-offs (convergence speed vs overfitting)
- ✅ Can recommend one approach with justification

**Key**: It's okay if learned PE is worse! The point is demonstrating you tested course concepts and can analyze results.

---

## 📊 What to Share with Claude After Each Run
...
3. **Critical Analysis** (10 pts)
   - "What is the impact?" → Help articulate practical value
   - "What does it reveal?" → Connect results to theory
   - "What's next?" → Suggest future directions
...
- [ ] Colab has GPU enabled (Runtime → Change runtime type → GPU)
...
## 🎯 Final Reminder: Rubric Over Perfection
...
### **Quick Reference:**
- **What to run?** → See Experiment 1, 2, 3 configs
- **What to share?** → See "What to Share with Claude" sections
- **What if stuck?** → See "Risk Management" section
- **Am I on track?** → Check timeline vs. current date
...
**Good luck! This plan is optimized for maximum rubric points with minimum time investment. Stay focused on Tier 1 experiments and remember: working demo > perfect results. 🚀**
